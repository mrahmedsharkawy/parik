...
for(const message of ['كم سعر كوب الشاي','لو عايز 10','10 بكام','كم سعر كوب القهوة','عايز 3','سؤال غير موجود عن مركبة فضائية']){
  ...
  console.log(JSON.stringify({message,reply:data.reply,action:data.action,knowledge_id:data.knowledge_id,unanswered:data.unanswered,products:(data.products||[]).map(x=>x.id)}));
