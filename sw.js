...
self.addEventListener('fetch', function(e) {
  ...
  const isFreshHtmlPage = path === '/' || path === '/index.html' || isAuthPage || path === '/account' || path === '/account.html' || path === '/Cart' || path === '/Cart.html' || path === '/admin' || path === '/admin.html';
