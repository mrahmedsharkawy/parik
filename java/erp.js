(function () {
  ...
  function setView(view) {
    ...
    $("erpPageTitle").textContent = titles[view][0];
    $("erpPageSubtitle").textContent = titles[view][1];
    document.body.classList.remove("erp-menu-open");
  ...
  function bindEvents() {
    ...
    $("erpMenuBtn").addEventListener("click", () => document.body.classList.toggle("erp-menu-open"));
    document.addEventListener("click", (event) => {
      if (document.body.classList.contains("erp-menu-open") && !event.target.closest(".erp-sidebar") && !event.target.closest("#erpMenuBtn")) {
        document.body.classList.remove("erp-menu-open");
      }
    });
