(function () {
  ...
  var REFRESH_KEY = 'sw-v414-api-network-bypass';
  var refreshed = false;
  ...
  function clearOldCaches() {
    ...
    caches.keys().then(function (keys) {
      keys.forEach(function (key) {
        if (key !== 'bariq-v414-api-network-bypass') caches.delete(key).catch(function () {});
      });
    }).catch(function () {});
  }
  ...
  navigator.serviceWorker.register('/sw.js?v=414-api-network-bypass', { updateViaCache: 'none' }).then(function (reg) {
    clearOldCaches();
