      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            AppStrings.tr('مرحباً بك', 'Welcome'),
          ...
          Text(
            ...
            AppStrings.tr('سجل دخولك أو أنشئ حساباً جديداً', 'Sign in or create a new account'),
            ...
            child: Column(
              ...
              children: [
                ...
                if (signup) ...[
                  ...
                  _FieldLabel(AppStrings.tr('الاسم الكامل', 'Full name')),

                  _TextInput(

                    controller: name,

                    hint: AppStrings.tr('الاسم الكامل', 'Full name'),
                ...
                _FieldLabel(AppStrings.tr('البريد الإلكتروني', 'Email')),
                ...
                if (signup) ...[
                  ...
                  _FieldLabel(AppStrings.tr('رقم الهاتف', 'Phone number')),
                  ...
                  _FieldLabel(AppStrings.tr('العنوان', 'Address')),

                  _TextInput(

                    controller: address,

                    hint: AppStrings.tr('الإمارة / المنطقة / العنوان', 'Emirate / Area / Address'),
                ...
                _FieldLabel(AppStrings.tr('كلمة المرور', 'Password')),
                ...
                if (!signup) ...[
                  ...
                  Align(
                    ...
                    child: TextButton(
                      ...
                      child: Text(AppStrings.tr('نسيت كلمة المرور؟', 'Forgot password?')),
                ...
                FilledButton(
                  ...
                  child: loading
                      ...
                      : Text(
                          ...
                          signup ? AppStrings.tr('إنشاء حساب', 'Create account') : AppStrings.login,
          ...
          TextButton(
            ...
            child: Text(
              ...
              AppStrings.tr('← العودة للمتجر', 'Back to store →'),
      ...
      child: Row(
        ...
        children: [
          ...
          _TabButton(
            ...
            label: AppStrings.tr('تسجيل الدخول 🔑', 'Sign in 🔑'),
          ...
          _TabButton(
            ...
            label: AppStrings.tr('إنشاء حساب 📝', 'Create account 📝'),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            AppStrings.tr('الدخول بحساب Google', 'Continue with Google'),
